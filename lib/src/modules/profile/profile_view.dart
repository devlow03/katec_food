        ...
        children: [
          Row(
            ...
            children: [
              const CircleAvatar(
                radius: 30,
                backgroundImage: NetworkImage("https://mighty.tools/mockmind-api/content/human/5.jpg"),
              ),
              ...
              Column(
                ...
                children: [
                  ...
                  Text("Nguyễn văn A",style: TextStyle(color: Colors.white,fontWeight: FontWeight.w700,fontSize: 16),),
                  Container(
                      ...
                      child: const Text("Phụ huynh học sinh",style: TextStyle(color: Colors.white,fontWeight: FontWeight.w700,fontSize: 16),)),
                ],
              ),
            ],
          ),
          ...
          children: [
            Container(
              ...
              child: const CircleAvatar(
                radius: 30,
                backgroundImage: NetworkImage("https://mighty.tools/mockmind-api/content/human/49.jpg"),
    ...
    return ListView.separated(
      ...
      itemBuilder: (context,index){
        return Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text(titleItem[index],style: const TextStyle(
                fontSize: 20,
                fontWeight: FontWeight.bold
            ),),
            const SizedBox(height: 10,),
